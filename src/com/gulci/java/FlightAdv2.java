...
public class FlightAdv2 implements Comparable<FlightAdv2>, Iterable<Person> {
...
//    }
    ...
    public int compareTo(FlightAdv2 fa) {
...
//        // we have access to crew and roster from enclosing FlightAdv2 class
//        // FlightIterator has FlightAdv2.this reference
//
//        private int index = 0;
//
//        @Override
...
//    }
    ...
    */
    ...
    public FlightAdv2 createNewWithBoth(FlightAdv f2, String newId) {
        FlightAdv2 newFlight = new FlightAdv2(newId);
